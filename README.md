...
替换 `希沃桌面 2.0` 自带的桌面批注程序为其它屏幕批注程序，目前仅支持在 Windows 10 上运行，且仅适配 [InkCanvasForClass Community Edition](https://github.com/InkCanvasForClass/community/) 1.7.18.7 以上的版本。
...
注意：在安装后，请前往开始菜单通过 `希沃批注替换` 快捷方式打开本程序的设置窗口。